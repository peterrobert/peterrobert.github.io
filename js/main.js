...
if ('serviceWorker' in navigator) {
	...
	window.addEventListener('load', function () {
		...
		navigator.serviceWorker.register('/sw.js').then(function (registration) {
			...
			toastr["success"]("ServiceWorker registration successful!");
...
document.querySelector('#promptbtn').addEventListener('click', () => {
	...
	if (promptEvnt !== undefined) {

		promptEvnt.prompt();
		promptEvnt.userChoice.then(choice => {

			var message = choice.outcome;
			if (message == 'dismissed') {

				toastr["error"]("app installation cancelled")

			} else {


				toastr["success"]("installing peter robert app now!");
